...
After the progrm finishes running, it will print the amount of times the word that you typed in showed up in the particular range you specified. Next, the program
...
the line, and I determined if a word was unevenly distributed if it varied by 1/5 or 5 times the original frequency per 5000 words. 
